...
import { removeProduct, decreaseQuantity, increaseQuantity, clearBasket } from "../store/reducer";
      ...
      <div className="list-container">
        {Array.isArray(basketArr) && basketArr.length > 0 ? (
          <>
            ...
            <div className="ShoppingCart-products-list">
              {basketArr.map((product, index) => (
                <div key={index} className="ShoppingCart-product-item">
                  <div className="ShoppingCart-product-info-container">
                    ...
                    <div className="ShoppingCart-product-text-container">
                      <div className="ShoppingCart-product-text">
                        <h3>{product.name}</h3>
